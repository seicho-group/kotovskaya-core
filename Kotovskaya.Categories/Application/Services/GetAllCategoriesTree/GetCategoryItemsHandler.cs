    ...
    : IRequestHandler<GetAllCategoriesTreeRequest, List<CategoryDtoBranch>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        result.ForEach(cat => { cat.CategoryItems = GetCategoryItems(cat, subCategories.ToList()); });

        return result;
    }

    private List<CategoryDtoBranch>? GetCategoryItems(CategoryDtoBranch parentBranch,
